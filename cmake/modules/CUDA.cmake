...
if(CUDA_FOUND)
  ...
  include_directories(${CUDA_CUPTI_INCLUDE_DIRS})
  include_directories(${CUDA_NVPERF_INCLUDE_DIRS})
endif(CUDA_FOUND)
...
if(USE_CUDA)
  ...
  if(USE_NVML)
    message(STATUS "Build with cuNVML support")
    list(APPEND TVM_RUNTIME_LINKER_LIBS ${CUDA_NVML_LIBRARY})
    list(APPEND TVM_LINKER_LIBS ${CUDA_NVML_LIBRARY})
  endif(USE_NVML)

  if(USE_CUPTI)
    message(STATUS "Build with cuCUPTI support")
    message(STATUS "Build with NVPERF support")
    list(APPEND TVM_RUNTIME_LINKER_LIBS ${CUDA_CUPTI_LIBRARY})
    list(APPEND TVM_LINKER_LIBS ${CUDA_CUPTI_LIBRARY})
    list(APPEND TVM_RUNTIME_LINKER_LIBS ${CUDA_NVPERF_LIBRARY_HOST})
    list(APPEND TVM_LINKER_LIBS ${CUDA_NVPERF_LIBRARY_HOST})
    list(APPEND TVM_RUNTIME_LINKER_LIBS ${CUDA_NVPERF_LIBRARY_TARGET})
    list(APPEND TVM_LINKER_LIBS ${CUDA_NVPERF_LIBRARY_TARGET})
  endif(USE_CUPTI)
